                                ...
                                <table class="groupped-table">
                                    ...
                                    <tbody>
                                        <tr class="single-groupped-item">
                                            <th>
                                                <div class="product-groupped-item">
                                                    <a class="product-title" href="#">Black teapot</a>
                                        ...
                                        <tr class="single-groupped-item">
                                            <th>
                                                <div class="product-groupped-item">
                                                    <a class="product-title" href="#">Teapot with black tea</a>
                                    ...
                                    <div class="quickview-cart-box">
                                        ...
                                        <div class="quickview-button">
                                            <div class="quickview-cart w-100  button ml-0">
                                                <a href="index.php?p=product-details" class="btn--lg w-100 text-center btn--black font-weight--reguler text-white">Add to cart</a>
                                            </div>

...
<!-- Mirrored from htmldemo.net/furninest/furninest/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Apr 2025 03:25:09 GMT -->
<head>
    <meta charset="utf-8">
...
<body class="@@body-box">
    ...
    <div class="site-wrapper-reveal">
        ...
        <div class="fullpage-area" id="fullpage">
            <div class="section">
                <div class="single-hero-slider-one bg-img" data-bg="assets/images/hero/home-para-1.webp">
                    <div class="container-fluid container-fluid--cp-100">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="hero-text">
                                    <h6 class="mb-20">CHAIR <br> COLLECTION <br> 2022</h6>
                                    <h1>Vase Decorated <br>  With Pine</h1>
                                    <div class="button-box mt-30">
                                        <a href="#" class="hero-btn">Shop now <i class="icon-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="fullpage-fotter-area">
                        <div class="container-fluid container-fluid--cp-100">
                            <div class="row">
                                <div class="col-6">
                                    <ul class="fullpage-social-list d-flex">
                                        <li><a href="#"><i class="social social_twitter"></i></a></li>
                                        <li><a href="#"><i class="social social_facebook"></i></a></li>
                                        <li><a href="#"><i class="social social_rss"></i></a></li>
                                    </ul>
                                </div>
            ...
            <div class="section">
                <div class="single-hero-slider-one bg-img" data-bg="assets/images/hero/home-para-2.webp">
                    <div class="container-fluid container-fluid--cp-100">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="hero-text">
                                    <h6 class=" mb-20">CHAIR <br> COLLECTION <br> 2022</h6>
                                    <h1>Wooden Kitchen <br>  Utensils</h1>
            ...
            <div class="section">
                <div class="single-hero-slider-one bg-img" data-bg="assets/images/hero/home-para-3.webp">
                    <div class="container-fluid container-fluid--cp-100">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="hero-text">
...
<!-- Mirrored from htmldemo.net/furninest/furninest/index-6.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Apr 2025 03:25:12 GMT -->
</html>
                                        ...
                                        <div class="tab-content" id="myaccountContent">
                                            ...
                                            <div class="tab-pane fade show active" id="dashboad" role="tabpanel">
                                                <div class="myaccount-content">
                                                    ...
                                                    <div class="welcome">
                                                        <p>Hello, <strong>Alex Aya</strong> (If Not <strong>Aya !</strong><a href="index.php?p=login" class="logout"> Logout</a>)</p>
                                                    </div>
                                                        ...
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td>Pending</td>
                                                                    <td>$3000</td>
                                                                    <td><a href="index.php?p=cart" class="btn btn btn-dark btn-hover-primary btn-sm rounded-0">View</a></td>
                                                                </tr>
                                                                <tr>
                                                                    <td>2</td>
                                                                    <td>July 22, 2018</td>

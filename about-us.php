            ...
            <div class="about-us-pages-area">
                        ...
                        <div class="row row--6">
                            <div class="col-lg-8 col-md-8">
                                <div class="banner-product-image mt-10">
                                    <a href="#">
                                        <img src="assets/images/banners/im-md-1-780x770.webp" class="img-fluid" alt="Banner images">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4">
                                <div class="banner-product-image mt-10">
                                    <a href="#">
                                        <img src="assets/images/banners/im-md-2-380x380.webp" class="img-fluid" alt="Banner images">
                                    </a>
                                </div>
                                <div class="banner-product-image mt-10">
                                    <a href="#">
                                        <img src="assets/images/banners/im-md-3.webp" class="img-fluid" alt="Banner images">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="banner-product-image mt-10">
                                    <a href="#">
                                        <img src="assets/images/banners/im-md-4-380x380.webp" class="img-fluid" alt="Banner images">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-8">
                                <div class="banner-product-image mt-10">
                                    <a href="#">
                                        <img src="assets/images/banners/im-md-5-780x380.webp" class="img-fluid" alt="Banner images">
                                    </a>
                                </div>
                            </div>
                ...
                <div class="addres-area section-space--pb_90">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-7">
                                <div class="furninest-section-title text-start section-space--mt_60">

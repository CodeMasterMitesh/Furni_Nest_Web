                                    ...
                                    <div class="quickview-cart-box">
                                        ...
                                        <div class="quickview-button">
                                            <div class="quickview-cart button">
                                                <a href="product-details.php" class="btn--lg btn--black font-weight--reguler text-white">Add to cart</a>
                                            </div>
                    ...
                    <ul>
                            ...
                            <ul class="sub-menu">
                                <li class="has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="shop-carousel.php"><span>Shop Carousel</span></a></li>
                                        <li><a href="shop-with-boder.php"><span>Shop With Border</span></a></li>
                                        ...
                                        <li><a href="shop-without-gutter.php"><span>Shop Without Gutter</span></a></li>
                                    </ul>
                                </li>
                                <li class="has-children">
                                    <a href="#"><span>Product Pages</span></a>
                                    <ul class="sub-menu">
                                        <li><a href="product-details.php"><span>Default</span></a></li>
                                        <li><a href="product-simple.php"><span>Simple</span></a></li>
                                        <li><a href="product-variable.php"><span>Variable</span></a></li>
                                        <li><a href="product-groupped.php"><span>Groupped</span></a></li>
                                        <li><a href="product-on-sale.php"><span>On Sale</span></a></li>
                                        <li><a href="product-out-of-stock.php"><span>Out Of Stock</span></a></li>
                                        <li><a href="product-affiliate.php"><span>Affiliate</span></a></li>
                                        <li><a href="product-image-swatches.php"><span>Image Swatches</span></a></li>
                                        <li><a href="product-countdown-timer.php"><span>With Countdown Timer</span></a></li>
                                    </ul>
                                </li>
                                <li class="has-children">
                        ...
                        <li class="has-children">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li><a href="faq.php"><span>FAQ Pages</span></a></li>
                        ...
                        <li class="has-children">
                            ...
                            <ul class="sub-menu">
                                <li><a href="blog-grid.php"><span>Blog Grid</span></a></li>
                                <li><a href="blog-listing.php"><span>Blog List</span></a></li>
                                <li><a href="blog-masonry.php"><span>Blog Masonry</span></a></li>
                                <li><a href="blog-left-sidebar.php"><span>Blog Sidebar</span></a></li>
                                <li><a href="single-blog-post.php"><span>Single Post V1</span></a></li>
                                <li><a href="single-blog-post-2.php"><span>Single Post V2</span></a></li>
                            </ul>
                        </li>
    ...
    <div class="offcanvas-minicart_wrapper" id="miniCart">
        <div class="offcanvas-menu-inner">
                ...
                <ul class="minicart-list">
                    <li class="minicart-product">
                        ...
                        <div class="product-item_content">
                            <a class="product-item_title" href="product-details.php">Plant pots</a>
                    ...
                    <li class="minicart-product">
                        ...
                        <div class="product-item_content">
                            <a class="product-item_title" href="product-details.php">Teapot with black tea</a>
                            <label>Qty : <span>1</span></label>
                            <label class="product-item_quantity">Price: <span> $20.00</span></label>
                        </div>
                    </li>
                    <li class="minicart-product">
                        ...
                        <div class="product-item_content">
                            <a class="product-item_title" href="product-details.php">Simple Chair</a>
                            <label>Qty : <span>1</span></label>
                            <label class="product-item_quantity">Price: <span> $20.00</span></label>
                        </div>
                    </li>
            ...
            <div class="minicart-btn_area">
                <a href="cart.php" class="btn btn--full btn--border_1">View cart</a>
            </div>
            <div class="minicart-btn_area">
                <a href="checkout.php" class="btn btn--full btn--black">Checkout</a>
            </div>
        </div>

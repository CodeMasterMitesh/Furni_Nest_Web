            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3">
                    <div class="row align-items-center">
                        <div class="col-md-6">
                            <h5 class="mb-0"><i class="fas fa-plus-circle me-2"></i>Add New software</h5>
                        </div>
                ...
                <div class="card-body">
                    <form id="addsoftwareForm" class="ajax-submit" action="../../ajax/insertdb.php" data-redirect="/admin/setup/software/software.php" method="POST">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control rounded-3 py-2" id="slug" name="slug" required>

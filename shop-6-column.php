                                    ...
                                    <div class="shop-toolbar__item">
                                        <ul class="nav toolber-tab-menu justify-content-start" role="tablist">
                                            ...
                                            <li class="tab__item nav-item">
                                                <a class="nav-link " data-bs-toggle="tab" href="#tab_columns_02" role="tab"><img src="assets/images/svg/column-05.svg" class="img-fluid" alt="Columns 03"> </a>
                                            </li>
                                            <li class="tab__item nav-item">
                                                <a class="nav-link active" data-bs-toggle="tab" href="#tab_columns_03" role="tab"><img src="assets/images/svg/column-06.svg" class="img-fluid" alt="Columns 03"> </a>
                                            </li>
                                        </ul>
                                    </div>

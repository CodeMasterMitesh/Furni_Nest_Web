...
<!-- Mirrored from htmldemo.net/furninest/furninest/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Apr 2025 03:25:01 GMT -->
<head>
        ...
        <div class="header-left-sidebar__content">
            ...
            <div class="header-left-sidebar__content-body">
                ...
                <div class="mobile-menu-overlay__body ps-0 pe-0">
                        ...
                        <ul>
                            <li class="has-children">
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li><a href="index-9.html"><span>Home V12 – Feature</span></a></li>
                                </ul>
                            </li>
                            <li class="has-children">
                                <a href="#">Shop</a>
                    ...
                    <div class="currency-selector-top-area section-space--mt_60  border-top">
                        <div class=" row section-space--mt_60 ">
                            <div class="widget-language col-md-12 mb-20">
                                <ul>
                                    <li class="actived"> <a href="#">English</a> <i class="fa fa-caret-down"></i></li>
                            ...
                            <div class="widget-currency col-md-12">
                                <ul>
                                    <li class="actived"><a href="#">USD</a> <i class="fa fa-caret-down"></i></li>
                                    <li><a href="#">Euro</a></li>
                    ...
                    <div class="slidebar-newsletter section-space--mt_60 border-top">
                        <h5 class="section-space--mt_60">Newsletter</h5>
                        <div class="newsletter-slidebar-box mt-30">
    ...
    <div class="page-template-template-home-left-sidebar">
        ...
        <div class="site-wrapper-reveal">
            ...
            <div class="hero-area hero-slider-four">
                <div class="single-hero-slider-four">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="hero-content-wrap">
                                    <div class="hero-text-7 mt-lg-5">
                                        <h1>The Latest Collection <br>  Of Furniture</h1>

                                        <p class="mt-30">On the other hand, we denounce with righteous indignation and dislike <br>  men who are so beguiled and demoralized by the charms of pleasure</p>

                                        <div class="button-box section-space--mt_60">
                                            <a href="#" class="text-btn-normal font-weight--reguler font-lg-p">Discover now <i class="arrow_carrot-2right"></i></a>
                                        </div>
                                    </div>
                                    <div class="inner-images">
                                        <div class="image-one">
                                            <img src="assets/images/hero/home-left-sidebar-1.webp" class="img-fluid" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="hero-content-wrap">
                                    ...
                                    <div class="inner-images">
                                        <div class="image-one">
                                            <img src="assets/images/hero/home-left-sidebar-2.webp" class="img-fluid" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row gx-0 align-items-center bg-gray">
                                        <div class="col-lg-7">
                                            <div class="about-us-content-4 ">
                                                ...
                                                <p class="pb-lg-5">Minimalist styling is not about creating a cold, hard, empty white box of a home. It is about using simple and natural forms, and taking away layers without losing the aesthetic appeal of the space. The focus is on shape, colour and texture, with a furniture and accessories.</p>
                                                <div class="button-box section-space--mt_60">
                                                    <a href="#" class="btn--text-icon">See more <i class="arrow_carrot-2right"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-5">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="banner-images-one mt-30">
                                <a href="#" class="thumbnail">
                                    <img src="assets/images/banners/hl-sb-1.webp" width="561" height="295" class="img-fluid" alt="Banner images">
                                </a>
                                <div class="banner-title">
                                    <h3><a href="#">Ritchie chair</a></h3>
                                    <h6>Chair collection</h6>
                                    <div class="button-box section-space--mt_60">
                                        <a href="#" class="text-btn-normal">Shop now <i class="icon-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="banner-images-one mt-30">
                                <a href="#" class="thumbnail">
                                    <img src="assets/images/banners/hl-sb-2.webp" width="561" height="295" class="img-fluid" alt="Banner images">
                                </a>
                                <div class="banner-title">
                                    <h3><a href="#">Ritchie chair</a></h3>
                                    <h6>Chair collection</h6>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-5 col-md-4">
                                        <div class="section-title small-mb__40 tablet-mb__40">
                                            <h4 class="section-title">Get Discount 50% Off</h4>
...
<!-- Mirrored from htmldemo.net/furninest/furninest/index-4.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Apr 2025 03:25:03 GMT -->
</html>
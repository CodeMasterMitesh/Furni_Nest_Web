                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-6 col-sm-12 col-xs-12">
                            ...
                            <div class="product-details-left">
                                <div class="product-details-images-2 slider-lg-image-2">
                                    ...
                                    <div class="easyzoom-style">
                                        <div class="easyzoom easyzoom--overlay">
                                            <a href="assets/images/product/single-product-01.webp" class="poppu-img">
                                    ...
                                    <div class="easyzoom-style">
                                        <div class="easyzoom easyzoom--overlay">
                                            <a href="assets/images/product/single-product-02.webp" class="poppu-img">
                                                <img src="assets/images/product/single-product-03.webp" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="easyzoom-style">
                                        <div class="easyzoom easyzoom--overlay">
                                            <a href="assets/images/product/single-product-03.webp" class="poppu-img">
                                                <img src="assets/images/product/single-product-03.webp" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="easyzoom-style">
                                        <div class="easyzoom easyzoom--overlay">
                                            <a href="assets/images/product/single-product-04.webp" class="poppu-img">
                                                <img src="assets/images/product/single-product-04.webp" class="img-fluid" alt="">
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="product-details-thumbs-2 slider-thumbs-2">
                                    <div class="sm-image"><img src="assets/images/product/small/1-100x100.webp" alt="product image thumb"></div>
                                    <div class="sm-image"><img src="assets/images/product/small/2-100x100.webp" alt="product image thumb"></div>
                                    <div class="sm-image"><img src="assets/images/product/small/3-100x100.webp" alt="product image thumb"></div>
                                    <div class="sm-image"><img src="assets/images/product/small/4-100x100.webp" alt="product image thumb"></div>
                                </div>
                            </div>
                            <!--// Product Details Left -->
                        </div>
                        <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                            <div class="product-details-content">
                                ...
                                <div class="variable-color-selector mt-20 variations">
                                ...
                                <div class="variable-size-selector mt-20 variations">
                                    <label>Select Size</label>
                                    <select>
                                        <option value="">Select Size</option>
                                        <option value="black" class="attached enabled">Large</option>
                                        <option value="grey" class="attached enabled">Medium</option>
                                        <option value="white" class="attached enabled">Small</option>
                                    </select>
                                </div>

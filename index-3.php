...
<!-- Mirrored from htmldemo.net/furninest/furninest/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Apr 2025 03:25:03 GMT -->
<head>
...
<body class="">
    ...
    <div id="main-wrapper">
        <div class="site-wrapper-reveal">
                    ...
                    <div class="row row--6">
                        <div class="col-lg-9 col-md-9">
                            <div class="banner-product-image mt-10">
                                <a href="#">
                                    <img src="assets/images/banners/bn1-2-1420x945.webp" width="1406" height="936" class="img-fluid" alt="Banner images">
                                </a>
                        ...
                        <div class="col-lg-3 col-md-3">
                            <div class="banner-product-image mt-10">
                                <a href="#">
                                    <img src="assets/images/banners/bn2-1.webp" width="461" height="461" class="img-fluid" alt="Banner images">
                                </a>
                                <div class="product-banner-title">
                                    <h3><a href="#">Plant pots</a></h3>
                                    <h6>Deco collection</h6>
                                </div>
                            </div>
                            <div class="banner-product-image mt-10">
                                <a href="#">
                                    <img src="assets/images/banners/bn3-1.webp" width="461" height="461" class="img-fluid" alt="Banner images">
                                </a>
                                <div class="product-banner-title">
                                    <h3><a href="#">Deco collection</a></h3>
                                    <h6>Deco collection</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="banner-product-image mt-10">
                                <a href="#">
                                    <img src="assets/images/banners/m4.webp" width="461" height="461" class="img-fluid" alt="Banner images">
                                </a>
                                <div class="product-banner-title">
                                    <h3><a href="#">Teapot black</a></h3>
                        ...
                        <div class="col-lg-8">
                            <div class="banner-product-image mt-10">
                                <a href="#">
                                    <img src="assets/images/banners/m5.webp" width="1249" height="619" class="img-fluid" alt="Banner images">
                                </a>
                                <div class="product-banner-title">
                                    <h3><a href="#">Helen pine table</a></h3>
                                    <h6>Chair collection</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="banner-product-image mt-10">
                                <a href="#">
                                    <img src="assets/images/banners/m6.webp" width="934" height="934" class="img-fluid" alt="Banner images">
                                </a>
                                <div class="product-banner-title">
                                    <h3><a href="#">Wooden decoration</a></h3>
                                    <h6>Chair collection</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="banner-product-image mt-10">
                                <a href="#">
                                    <img src="assets/images/banners/m7.webp" width="934" height="934" class="img-fluid" alt="Banner images">
                                </a>
                                <div class="product-banner-title">
                                    <h3><a href="#">Deco collection</a></h3>
                                    <h6>Chair collection</h6>
                        ...
                        <div class="col-lg-12">
                            <div class="banner-product-image mt-10">
                                <a href="#">
                                    <img src="assets/images/banners/m8.webp" width="1879" height="620" class="img-fluid" alt="Banner images">
                                </a>
                                <div class="product-banner-title">
                                    <h3><a href="#">Eikon drop lamp</a></h3>
                                    <h6>Deco collection</h6>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container-fluid">
                <div class="our-newsletter-area bg-gray mt-10 section-space--ptb_120">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                        ...
                        <div class="newsletter-wrap">
                            <form action="#" class="newsletter--three row">
                                <div class="single-input col-lg-6 col-md-6 mt-30">
...
<!-- Mirrored from htmldemo.net/furninest/furninest/index-3.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Apr 2025 03:25:07 GMT -->
</html>
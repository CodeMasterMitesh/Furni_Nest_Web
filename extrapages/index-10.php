...
<!-- Mirrored from htmldemo.net/furninest/furninest/index-10.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Apr 2025 03:24:57 GMT -->
<head>
                        ...
                        <div class="header__navigation d-none d-lg-block">
                            <nav class="navigation-menu d-flex align-items-center">
                                <ul class="justify-content-center">
                                    <li class="has-children has-children--multilevel-submenu">
                                        ...
                                        <ul class="submenu">
                                            ...
                                            <li><a href="index-9.html"><span>Home V11 – Minimal 02 Feature</span></a></li>
                                            <li><a href="index-13.html"><span>Home V13 – Minimal 03 Feature</span></a></li>
                                        </ul>
                                ...
                                <span class="d-none d-xl-block">
                                    <a href="#"><span class="phone-number font-lg-p"> <i class="icon-telephone"></i> +8 (268) 654 - 587- 68 </span></a>
                                </span>
                            </nav>
                        </div>
    ...
    <div id="main-wrapper">
        <div class="site-wrapper-reveal">
            ...
            <div class="hero-area hero-slider-10">
                            ...
                            <div class="col-lg-12">
                                <div class="hero-content-wrap">
                                    <div class="hero-text-7 mt-lg-5">
                                        ...
                                        <p class="mt-30">There are many variations of passages of Lorem Ipsum available, but <br> the majority have suffered alteration in some formr.</p>

                                        <div class="button-box section-space--mt_60">
                                            <a href="#" class="text-btn-normal font-weight--reguler font-lg-p">Shop Now <i class="icon-arrow-right"></i></a>
                                        </div>
                                    </div>
                                    <div class="inner-images">
                                        <div class="image-one">
                                            <img src="assets/images/hero/home-collection-1.webp" width="644" height="465" class="img-fluid" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="single-hero-slider-10" data-title="02">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="hero-content-wrap">
                                    ...
                                    <div class="inner-images">
                                        <div class="image-one">
                                            <img src="assets/images/hero/home-collection-2.webp" width="622" height="390" class="img-fluid" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="single-hero-slider-10" data-title="03">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="hero-content-wrap">
                                    ...
                                    <div class="inner-images">
                                        <div class="image-one">
                                            <img src="assets/images/hero/home-collection-3.webp" width="431" height="385" class="img-fluid" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="newsletter-wrap section-space--pt_90">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6">
                            <div class="section-title small-mb__40 tablet-mb__40">
                                <h2 class="mb-30">Sign Up To Get 50% Discount</h2>
                                <p>Subscribe to our newsletter and get a 50% discount.The joy of our customersis a great honor for us.</p>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="newsletter-wrap">
                                <form action="#" class="newsletter--four">
            ...
            <div class="arival-product-area section-space--ptb_90">
                <div class="container-fluid container-fluid--cp-100">
                    <div class="row">
                        <div class="col-lg-6 col-md-6">

                            <div class="single-product--03">
                                <a href="#"><img src="assets/images/banners/pr5-600x429.webp" width="600" height="429" class="img-fluid" alt="Images"></a>
                                <div class="product-content">
                                    <h2 class="mb-30"><a href="#">Drinking Glasses</a></h2>
                                    <div class="product-details">
                                        <p>Various versions have evolved over the years, some <br>  times by accident, some times on purpose.</p>
                                    </div>
                                    <div class="button-box section-space--mt_60">
                                        <a href="#" class="text-btn-normal font-weight--reguler font-lg-p" tabindex="0">Shop Now <i class="icon-arrow-right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="single-product--03 d-item mt-130">
                                <div class="product-content top--content order-md-1 order-2">
                                    <h2 class="mb-30"><a href="#">Hanna Chair</a></h2>
                                    <div class="product-details">
                                        <p>Various versions have evolved over the years, some <br>  times by accident, some times on purpose.</p>
                                    </div>
                                    <div class="button-box section-space--mt_60">
                                ...
                                <a href="#" class=" order-md-2 order-1"><img src="assets/images/banners/pr6-570x570.webp" width="570" height="570" class="img-fluid" alt="Images"></a>

                            </div>
                        </div>
                        <div class="col-lg-4  col-md-6 ms-auto">
                            <div class="single-product--03 small-mt__60">
                                <a href="#"><img src="assets/images/banners/pr7.webp" width="400" height="450" class="img-fluid" alt="Images"></a>
                                <div class="product-content top--content">
                                    <h2 class="mb-30"><a href="#">Wooden Cups</a></h2>
                                    <div class="product-details">
                                        <p>Various versions have evolved over the years, some <br>  times by accident, some times on purpose.</p>
                                    </div>
                                    <div class="button-box section-space--mt_60">
                        ...
                        <div class="col-lg-6 col-md-6 mt-180">
                            <div class="single-product--03">
                                <a href="#"><img src="assets/images/banners/pr8.webp" width="655" height="500" class="img-fluid" alt="Images"></a>
                                <div class="product-content top--content">
                                    <h2 class="mb-30"><a href="#">Table Black</a></h2>
                                    <div class="product-details">
                                        <p>Various versions have evolved over the years, some <br>  times by accident, some times on purpose.</p>
                                    </div>
                                    <div class="button-box section-space--mt_60">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-product--03 small-mt__60">
                                <a href="#"><img src="assets/images/banners/pr10-600x600.webp" wedth="600" height="600" class="img-fluid" alt="Images"></a>
                                <div class="product-content top--content">
                                    <h2 class="mb-30"><a href="#">Table Black</a></h2>
                                    <div class="product-details">
                                        <p>Various versions have evolved over the years, some <br>  times by accident, some times on purpose.</p>
                        ...
                        <div class="col-lg-4 col-md-6 ms-auto mt-180">
                            <div class="single-product--03">
                                <a href="#"><img src="assets/images/banners/pr9-405x405.webp" width="405" height="405" class="img-fluid" alt="Images"></a>
                                <div class="product-content top--content">
                                    <h2 class="mb-30"><a href="#">Table Black</a></h2>
                                    <div class="product-details">
                                        <p>Various versions have evolved over the years, some <br>  times by accident, some times on purpose.</p>
            ...
            <div class="footer-area section-space--ptb_90">
                <div class="container-fluid container-fluid--cp-100">
                    <div class="row footer-widget-wrapper">
                        ...
                        <div class="col-lg-2 offset-lg-1 col-md-4 col-sm-6 footer-widget">
...
<!-- Mirrored from htmldemo.net/furninest/furninest/index-10.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Apr 2025 03:25:01 GMT -->
</html>
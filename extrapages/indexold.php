...
<!-- Mirrored from htmldemo.net/furninest/furninest/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Apr 2025 03:24:39 GMT -->
<head>
        ...
        <div class="site-wrapper-reveal">
                    ...
                    <div class="row">
                        <div class="col-lg-12 ps-0 ps-lg-3 pe-0 pe-lg-3">
                            ...
                            <div class="hero-area hero-slider-one">
                                <div class="single-hero-slider-one bg-img" data-bg="assets/images/hero/home-default-1.webp">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="hero-text-one">
                                                    ...
                                                    <h1 class="hero-title">
                                                        Welcome To <br> FurniNest Store
                                                    </h1>
                                                    <p class="mt-30"> Many desktop publishing packages and web page editors now use <br>
                                                Lorem Ipsum as their default model text
                                                    </p>
                                                    <div class="button-box mt-30">
                                                        <a href="#" class="hero-btn-one btn">Shop now <i class="icon-arrow-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="single-hero-slider-one bg-img" data-bg="assets/images/hero/home-default-2.webp">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="hero-text-one">
                                                ...
                                                Lorem Ipsum as their default model text
                                                    ...
                                                    <div class="button-box mt-30">
                                                        <a href="shop-3-column.html" class="hero-btn-one btn">Shop now <i class="icon-arrow-right"></i></a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="single-hero-slider-one bg-img" data-bg="assets/images/hero/home-default-3.webp">
                                    <div class="container">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <div class="hero-text-one">
            ...
            <div class="featuted-product-wrap section-space--pt_120">
                    ...
                    <div class="row align-items-center featuted-product-one">
                        <div class="col-lg-6 col-md-6 order-md-1 order-1">
                            <div class="product-thumbnail">
                                <a href="#"><img src="assets/images/featured-product/df-1.webp" class="img-fluid" alt="Featured Image" height="451" width="397"></a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 order-md-2 order-2">
                            <div class="featured-product-contect">
                                ...
                                <h2 class="section-title--one"><a href="#">Nancy Chair</a></h2>
                                ...
                                <div class="button-box section-space--mt_60">
                                    <a href="product-details.html" class="btn btn--md btn--border_1">Only $90 <i class="icon-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="images-text-bg text-end">
                    <img src="assets/images/text-bg/bg-df-1-300x49.webp" class="img-fluid" width="300" height="49" alt="Wood Coth">
                </div>
            </div>
                ...
                <div class="container">
                    <div class="row align-items-center featuted-product-one">
                        <div class="col-lg-6 col-md-6 order-md-2 order-1">
                            <div class="product-thumbnail">
                                <a href="#"><img src="assets/images/featured-product/df-2.webp" class="img-fluid" alt="Table Wood Pine" width="561" height="266"></a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 order-md-1 order-2">
                            <div class="featured-product-contect">
                                <h6 class="sub-heading mb-2">FEATURED PRODUCT</h6>
                                <h2 class="section-title--one"><a href="#">Table Wood Pine</a></h2>
                                <p class="mt-30">Excepteur sint occaecat cupidatat non proident, sunt in culpaqui <br>
    officia deserunt mollit anim id est laborum</p>
                                <div class="button-box section-space--mt_60">
                                    <a href="product-details.html" class="btn btn--md btn--border_1">Only $50 <i class="icon-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="images-text-bg text-start">
                    <img src="assets/images/text-bg/h1-1-300x122.webp" class="img-fluid" width="300" height="122" alt="pine">
                </div>
            </div>
            ...
            <div class="featuted-product-wrap section-space--pt_120">
                <div class="container">
                    <div class="row align-items-center featuted-product-one">
                        <div class="col-lg-6 col-md-6 order-md-1 order-1">
                            <div class="product-thumbnail">
                                <a href="#"><img src="assets/images/featured-product/df-3.webp" class="img-fluid" alt="Featured Image" width="300" height="277"></a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6  order-md-2 order-2">
                            <div class="featured-product-contect">
                                <h6 class="sub-heading mb-2">FEATURED PRODUCT</h6>
                                <h2 class="section-title--one"><a href="#">Art Deco Home</a></h2>
                                <p class="mt-30">Many desktop publishing packages and web page editors now use <br>
    Lorem Ipsum as their default model text, and a search for.</p>
                                <div class="button-box section-space--mt_60">
                                    <a href="product-details.html" class="btn btn--md btn--border_1">Only $30 <i class="icon-arrow-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="images-text-bg text-end">
                    <img src="assets/images/text-bg/h1-2.webp" class="img-fluid" alt="art decorations" width="673" height="168">
                </div>
            </div>
                        ...
                        <div class="single-product-item text-center">
                            <div class="products-images">
                                <a href="product-details.html" class="product-thumbnail">
                                    <img src="assets/images/product/1_1-300x300.webp" class="img-fluid" alt="Product Images" width="300" height="300" width="300" height="300">
                                ...
                                <div class="col-lg-7 col-md-7">
                                    <div class="colection-info-wrap">
                                        ...
                                        <div class="timer text-center section-space--mt_60">
                                            <!-- countdown start -->
                                            <div class="countdown-deals counter-style--one" data-countdown="2024/12/12"></div>
                                            <!-- countdown end -->
                                        </div>
                    ...
                    <div class="row">
                            ...
                            <div class="single-blog-item mt-30">
                                <div class="blog-thumbnail-box">
                                    <a href="#" class="thumbnail">
                                        <img src="assets/images/blog/8-570x370.webp" class="img-fluid" alt="Blog Images" height="238" width="366">
                                    </a>
                        ...
                        <div class="col-lg-4 col-md-6  col-sm-6 col-12">
                            ...
                            <div class="single-blog-item mt-30">
                                <div class="blog-thumbnail-box">
                                    <a href="#" class="thumbnail">
                                        <img src="assets/images/blog/9-570x370.webp" class="img-fluid" alt="Blog Images" height="238" width="366">
                                    </a>
                                    <a href="#" class="btn-blog"> Read more </a>
                                </div>
                                <div class="blog-contents">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 col-12">
                            ...
                            <div class="single-blog-item mt-30">
                                <div class="blog-thumbnail-box">
                                    <a href="#" class="thumbnail">
                                        <img src="assets/images/blog/10-570x370.webp" class="img-fluid" alt="Blog Images" height="238" width="366">
                                    </a>
                                    <a href="#" class="btn-blog"> Read more </a>
                                </div>
                                <div class="blog-contents">
                        ...
                        <div class="col-lg-7 col-md-8">
                            <div class="newsletter-wrap">
                                <form action="#" class="newsletter--one">
                                    <input class="input-box" name="rememberme" type="text" placeholder="Your email address">
        ...
        <div class="footer-area-wrapper">
                    ...
                    <div class="row footer-widget-wrapper">
                        <div class="col-lg-4 col-md-4 col-sm-6 footer-widget">
                            ...
                            <ul class="footer-widget__list">
                                <li><i class="icon_pin"></i> FurniNest, Ahmedabad,Gujarat 2025</li>
            ...
            <div class="footer-copyright-area section-space--pb_30">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <span class="copyright-text text-center  section-space--mt_40">&copy; 2023 FurniNest. <a  href="https://hasthemes.com/" target="_blank">All Rights Reserved.</a></span>
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from htmldemo.net/furninest/furninest/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Apr 2025 03:24:41 GMT -->
</html>
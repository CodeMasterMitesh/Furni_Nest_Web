...
<!-- Mirrored from htmldemo.net/furninest/furninest/index-8.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Apr 2025 03:24:43 GMT -->
<head>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-4 col-md-5 col-6">
                        <div class="header-right-side text-end">
                            ...
                            <div class="header-right-items  d-none d-lg-block">
            ...
            <div class="hero-area overflow-hidden">
                ...
                <div class="container-fluid ml-0 mr-0">
                    <div class="row row--25 hero-slider-8">
                        <div class="col-lg-12 ">
                            <div class="single-hero-slider-7 bg-img" data-bg="assets/images/hero/sli-h1.webp">
                                <div class="hero-content-wrap">
                                    <div class="hero-text-7 mt-lg-5">

                                        <h1>Alarm Clock <br>  Carbon</h1>
                                        ...
                                        <div class="button-box section-space--mt_60">
                                            <a href="#" class="btn--border-bottom">Discover now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-12 ">
                            <div class="single-hero-slider-7 bg-img" data-bg="assets/images/hero/sl-d2.webp">
                                <div class="hero-content-wrap">
                                    <div class="hero-text-7 mt-lg-5">

                                        <h1>Angel <br>  Wooden Chair</h1>
                        ...
                        <div class="col-lg-12 ">
                            <div class="single-hero-slider-7 bg-img" data-bg="assets/images/hero/sl-h3.webp">
                                <div class="hero-content-wrap">
                                    <div class="hero-text-7 mt-lg-5">

                                        <h1>Bamboo <br> Wicker Basket</h1>
                    ...
                    <div class="row">
                        <div class="col-lg-5 col-md-5 col-sm-6">
                            <div class="section-title">
                                <h2>New Arival</h2>
                                <p class="mt-30">On the other hand, we denounce with right indignation and dislike men demoralized by the charms.</p>
                                <div class="button-box mt-30">
                                    <a href="#" class="btn--border-bottom">View more</a>
                                </div>
                            </div>

                            <div class="single-arival-product mt-130">
                                <a href="#"><img src="assets/images/banners/heledo-pd-2-400x500.webp" width="659" height="494" class="img-fluid" alt="Images"></a>
                                <div class="product-content">
                                    <h6><a href="#">Drinking Glasses</a></h6>
                            ...
                            <div class="single-arival-product mt-130">
                                <a href="#"><img src="assets/images/banners/heledo-pd-4-330x412.webp" width="464" height="579" class="img-fluid" alt="Images"></a>
                                <div class="product-content">
                                    <h6><a href="#">Basket Knitting</a></h6>
                                    <div class="product-price">
                                        <span>$960.00</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-6">
                            <div class="single-arival-product small-mt__60">
                                <a href="#"><img src="assets/images/banners/heledo-pd-1-700x525.webp" width="570" height="525" class="img-fluid" alt="Images"></a>
                                <div class="product-content">
                                    <h6><a href="#">Shell Chair Wooden</a></h6>
                                    <div class="product-price">
                                        <span>$960.00</span>
                                    </div>
                                </div>
                            </div>
                            <div class="single-arival-product mt-180">
                                <a href="#"><img src="assets/images/banners/heledo-pd-3-570x525.webp" width="570" height="525" class="img-fluid" alt="Images"></a>
                                <div class="product-content">
                                    <h6><a href="#">Wooden Flowerpot</a></h6>
                                    <div class="product-price">
                                        <span>$960.00</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6  col-md-6 col-sm-6 col-sm-6">
                            <div class="single-arival-product mt-130">
                                <a href="#"><img src="assets/images/banners/heledo-pd-6-570x365.webp" width="570" height="365" class="img-fluid" alt="Images"></a>
                                <div class="product-content">
                                    <h6><a href="#">Nancy chair</a></h6>
                                    <div class="product-price">
                                        <span>$660.00</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-6 ms-auto  small-mt__60">
                            <div class="single-arival-product">
                                <a href="#"><img src="assets/images/banners/heledo-pd-5-330x412.webp" width="330" height="412" class="img-fluid" alt="Images"></a>
                                <div class="product-content">
                                    <h6><a href="#">Plant Pots</a></h6>
                                    <div class="product-price">
                                        <span>$60.00</span>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="button-box text-center section-space--mt_60">
                                <a href="shop-4-column.html" class="btn--border-bottom">All Product</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- Mirrored from htmldemo.net/furninest/furninest/index-8.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Apr 2025 03:24:45 GMT -->
</html>
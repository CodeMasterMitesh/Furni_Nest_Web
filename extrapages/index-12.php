...
<!-- Mirrored from htmldemo.net/furninest/furninest/index-12.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Apr 2025 03:25:12 GMT -->
<head>
...
<body class="">
    ...
    <div class="hero-area-video dotted-overlay youtube-bg">
        <div class="single-hero-slider-12 ">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8 m-auto">
                        <div class="hero-text-12 text-center">

                            <h1 class="text-white mb-30">Interior Trend 2022</h1>
                            <p class="text-white mb-30">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Omnis nesciunt, hic modi, magni expedita officiis pariatur sed,</p>
    ...
    <!--====================  header area ====================-->
    <div class="header-area header-area--default bg-white position-relative z-index-1">
    ...
    <div id="main-wrapper">
        <div class="site-wrapper-reveal pt-5">
                                    ...
                                    <div class="row gx-0 align-items-center bg-gray">
                                        ...
                                        <div class="col-lg-5">
                                            <div class="elendo-video-box">
                                                <!-- <img src="assets/images/banners/video-banner.webp" class="img-fluid" alt="Video bg images"> -->
            ...
            <div class="our-newsletter-area section-space--ptb_60 bg-img" data-bg="assets/images/bg/11.webp">
                            ...
                            <div class="row align-items-center">
                                <div class="col-lg-6 col-md-7">
                                    <div class="section-title">
                                        <h2 class="section-title">Sign Up Of 25% Discount</h2>
                                        <p>Dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor!</p>
                                    </div>

                                    <div class="newsletter-wrap  mt-40">
                                        <form action="#" class="newsletter--two max-420">
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="more-button text-end">
                                <a href="blog-grid.html" class="text-btn-normal font-weight--reguler font-lg-p" tabindex="0">View All <i class="icon-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="footer-area section-space--ptb_90">
                <div class="container-fluid container-fluid--cp-100">
                    <div class="row footer-widget-wrapper">
                        <div class="col-lg-3 col-md-4 col-sm-5 footer-widget">
                        ...
                        <div class="col-lg-2 offset-lg-1 col-md-3 col-sm-5 footer-widget">
                        ...
                        <div class="col-lg-3 col-md-12 col-sm-7 footer-widget">

...
<!-- Mirrored from htmldemo.net/furninest/furninest/index-13.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Apr 2025 03:25:13 GMT -->
<head>
...
<body class="">
                                ...
                                <ul class="justify-content-center">
                                    <li class="has-children has-children--multilevel-submenu">
                                        ...
                                        <ul class="submenu">
                                            ...
                                            <li><a href="index-9.html"><span>Home V12 – Minimal 02 Feature</span></a></li>
    ...
    <div id="main-wrapper">
        ...
        <div class="site-wrapper-reveal">
            ...
            <div class="hero-area hero-slider-13">
                <div class="single-hero-slider-13">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="hero-content-wrap">
                                    ...
                                    <div class="inner-images">
                                        <div class="image-one">
                                            <img src="assets/images/hero/home-box-1.webp" width="443" height="244" class="img-fluid" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="hero-content-wrap">
                                    ...
                                    <div class="inner-images">
                                        <div class="image-one">
                                            <img src="assets/images/hero/home-box-2.webp" width="307" height="277" class="img-fluid" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-7 col-md-7">
                                    <div class="colection-info-wrap">
                                        ...
                                        <div class="timer text-center section-space--mt_60">
                                            <!-- countdown start -->
                                            <div class="countdown-deals counter-style--one" data-countdown="2024/12/01"></div>
                                            <!-- countdown end -->
                                        </div>

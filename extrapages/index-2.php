                    ...
                    <div class="col-lg-4 col-md-4 col-6">
                        <div class="header-right-side text-end">
                            ...
                            <div class="header-right-items d-block d-md-none">
                                <a href="javascript:void(0)" class="mobile-navigation-icon" id="mobile-menu-trigger-2">
                                    <i class="icon-menu"></i>
                                </a>
                            </div>
                        </div>
    ...
    <div id="main-wrapper">
        <div class="site-wrapper-reveal">
            ...
            <div class="hero-area hero-slider-two">
                <div class="single-hero-slider-one bg-img" data-bg="assets/images/hero/home-minimal-1.webp">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="hero-text-two text-center">

                                    <h1 class="hero-title--two">Interior Trends 2022</h1>
                                    <p class="mt-30"> On the other hand, we denounce with righteous indignation and dislike
                                        <br>
                                ...
                                pleasure of the moment.
                                    ...
                                    <div class="button-box section-space--mt_60">
                                        <a href="shop-4-column.html" class="btn--text-icon">Discover Now <i class="arrow_carrot-2right"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="single-hero-slider-one bg-img" data-bg="assets/images/hero/home-minimal-2.webp">
                    <div class="container">
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="hero-text-two text-center">
            ...
            <div class="about-us-area section-space--pt_120">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="hero-about-us-content text-center">
                                <p>“Minimalist styling is not about creating a cold, hard, empty white box of a home. It is about using simple
                                    and natural forms, and taking away layers without losing the aesthetic appeal of the space. The focus is on
                                    shape, colour and texture, with a minimum of furniture and accessories.”</p>

                                <div class="about-us-button section-space--mt_60">
                                    <a href="shop-4-column.html" class="btn--text-icon">More About Us <i class="arrow_carrot-2right"></i></a>
                                </div>
                    ...
                    <div class="row align-items-center featuted-product-one">
                        <div class="col-lg-6 col-md-6 order-lg-2 order-1">
                            <div class="product-thumbnail">
                                <a href="#"><img src="assets/images/featured-product/pr1.webp" height="367" width="561" class="img-fluid" alt="Featured Image"></a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 order-lg-1 order-2">
                            <div class="featured-product-contect">
                                <h3 class="section-title"><a href="#">Georg Jensen Minimal Clock</a></h3>
                                <h6 class="featured-pice">
                ...
                <div class="container">
                    <div class="row align-items-center featuted-product-one">
                        <div class="col-lg-8 col-md-6 order-lg-1 order-1">
                            <div class="product-thumbnail">
                                <a href="#"><img src="assets/images/featured-product/pr2-600x479.webp" height="479" width="600" class="img-fluid" alt="Featured Image"></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 order-lg-2 order-2">
                            <div class="featured-product-contect text-end">
                                <h3 class="section-title"><a href="#">Womb Chair – Saarinen</a></h3>
                                <h6 class="featured-pice">
                                    Just from <span> $35.00</span>
                                </h6>
            ...
            <div class="featuted-product-wrap section-space--pt_120">
                <div class="container">
                    <div class="row align-items-center featuted-product-one">
                        <div class="col-lg-6 col-md-6 order-lg-2 order-1">
                            <div class="product-thumbnail">
                                <a href="shop-4-column.html"><img src="assets/images/featured-product/pr3-600x375.webp" height="367" width="561" class="img-fluid" alt="Featured Image"></a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 order-lg-1 order-2">
                            <div class="featured-product-contect">
                                <h3 class="section-title"><a href="#">Nancy flower vase</a></h3>
                                <h6 class="featured-pice">
                                    Just from <span> $50.00</span>
                                </h6>
            ...
            <div class="featuted-product-wrap section-space--pt_120">
                <div class="container">
                    <div class="row align-items-center featuted-product-one">
                        <div class="col-lg-8 col-md-6 order-lg-1 order-1">
                            <div class="product-thumbnail">
                                <a href="shop-4-column.html"><img src="assets/images/featured-product/pr4.webp" height="367" width="561" class="img-fluid" alt="Featured Image"></a>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 order-lg-2 order-2">
                            <div class="featured-product-contect text-end">
                                <h3 class="section-title"><a href="#">FurniNest tea table</a></h3>
                                <h6 class="featured-pice">
                                    Just from <span> $285.00</span>
                                </h6>

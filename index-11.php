...
<!-- Mirrored from htmldemo.net/furninest/furninest/index-11.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Apr 2025 03:24:45 GMT -->
<head>
                    ...
                    <div class="row row--5">
                        <div class="col-lg-3 col-md-3">
                            <div class="hero-product-image mt-10">
                                <a href="#">
                                    <img src="assets/images/banners/h-g-1.webp" width="279" height="388" class="img-fluid" alt="Banner images">
                                </a>
                                <div class="product-banner-title">
                                    <h4><a href="#">Wooden deco</a></h4>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="hero-product-image mt-10">
                                <a href="#">
                                    <img src="assets/images/banners/h-g-2.webp" width="568" height="388" class="img-fluid" alt="Banner images">
                                </a>
                                <div class="product-banner-title">
                                    <h4><a href="#">Helen chair</a></h4>
                                    <h6>Deco collection</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3">
                            <div class="hero-product-image mt-10">
                                <a href="#">
                                    <img src="assets/images/banners/h-g-3.webp" width="279" height="388" class="img-fluid" alt="Banner images">
                                </a>
                                <div class="product-banner-title">
                                    <h4><a href="#">Vase of flowers</a></h4>
                                    <h6>Deco collection</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="hero-product-image mt-10">
                                <a href="#">
                                    <img src="assets/images/banners/h-g-4.webp" width="568" height="245" class="img-fluid" alt="Banner images">
                                </a>
                                <div class="product-banner-title">
                                    <h4><a href="#">Wood eggs</a></h4>
                                    <h6>Deco collection</h6>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6">
                            <div class="hero-product-image mt-10">
                                <a href="#">
                                    <img src="assets/images/banners/h-g-5.webp" width="568" height="245" class="img-fluid" alt="Banner images">
                                </a>
                                <div class="product-banner-title">
                                    <h4><a href="#">TV shelves Helen</a></h4>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="banner-video-box">
                                <img src="assets/images/bg/video-banner2.webp" width="1170" height="450" alt="Viedeo Banner Image">
                                <div class="video-icon">
                                    <a href="#"><i class="linear-ic-play"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-sm-6">
                                    ...
                                    <div class="single-product-item text-center">
                                        <div class="products-images">
                                            ...
                                            <div class="product-actions">
                                                <a href="#" data-bs-toggle="modal" data-bs-target="#prodect-modal-2"><i class="p-icon icon-plus"></i><span class="tool-tip">Quick View</span></a>
                                                <a href="product-details.html"><i class="p-icon icon-bag2"></i> <span class="tool-tip">Add to cart</span></a>
                                                <a href="wishlist.html"><i class="p-icon icon-heart"></i> <span class="tool-tip">Browse Wishlist</span></a>
                                            </div>
                                        </div>
...
<!-- Mirrored from htmldemo.net/furninest/furninest/index-11.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 19 Apr 2025 03:24:57 GMT -->
</html>